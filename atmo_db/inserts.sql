...
INSERT into Audio_File (title, description, file_type, url, user_id) VALUES ('AES Explained', 'From Computerphile', 'mp3', 'https://www.youtube.com/watch?v=O4xNJsjtN6E', 1);
INSERT into Audio_File (title, description, file_type, url, user_id) VALUES ('Eliptic Curves', 'From Computerphile', 'mp3', 'https://www.youtube.com/watch?v=NF1pwjL9-DE', 1);
